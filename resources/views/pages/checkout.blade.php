          ...
          <div class="card card-details">
              ...
              <table class="table table-responsive-sm text-center">
                ...
                <tbody>
                  @forelse ($item->details as $detail)
                    <tr>
                      <td><img src="https://ui-avatars.com/api/?name={{$detail->username}}" height="50px" class="rounded-circle"/></td>
            ...
            <div class="member mt-3">
              ...
              <form class="form-inline" method="POST" action="{{ route('checkout-create', $item->id) }}">
                ...
                <input type="text" class="form-control mb-2 mr-sm-2" id="username" name="username" placeholder="Username" style="width: 150px">
